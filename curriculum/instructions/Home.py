...
section_dir = Path(__file__).parent # "/instructions"
exercises_dir = section_dir.parent # "/chapter3_llm_evaluations"
...
# Root diagram URL
ROOT_URL = "https://raw.githubusercontent.com/chloeli-15/ARENA_img/main/img/"
...
* Generate your own MCQ eval dataset from scratch using LLMs, implementing Anthropic's [model-written eval](https://arxiv.org/abs/2212.09251) method
...
# """),
#     "leaves": ("Running Evals with Inspect", r"""
...
├── chapter3_llm_evals
│   ├── exercises
│   │   ├── part1_intro_to_evals
│   │   │   ├── solutions.py
│   │   │   ├── tests.py
│   │   │   └── answers.py*
│   │   ├── part2_dataset_generation
│   │   ⋮    ⋮
│   └── instructions
│       └── Home.py
└── requirements.txt
